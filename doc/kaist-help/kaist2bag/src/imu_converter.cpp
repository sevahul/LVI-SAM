...
ImuConverter::ImuConverter(const std::string &dataset_dir,
                           const std::string &save_dir,
                           const std::string &irp_topic,
                           const std::string &raw_topic,
                           const std::string &mag_topic)
    : Converter(dataset_dir, save_dir), irp_topic_(irp_topic),
      raw_topic_(raw_topic), mag_topic_(mag_topic) {
...
int ImuConverter::Convert() {
  ...
  // boost::filesystem::path irp_bag_file = boost::filesystem::path(save_dir_) /
  // irp_bag_name_;
  boost::filesystem::path raw_bag_file =
      boost::filesystem::path(save_dir_) / raw_bag_name_;
  // boost::filesystem::path mag_bag_file = boost::filesystem::path(save_dir_) /
  // mag_bag_name_; rosbag::Bag irp_bag(irp_bag_file.string(),
